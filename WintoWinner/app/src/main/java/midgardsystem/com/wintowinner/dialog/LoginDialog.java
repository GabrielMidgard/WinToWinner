...
/**
 * Created by Gabriel on 01/09/2016.
 */
public class LoginDialog  extends DialogFragment {
    ...
    public LoginDialog(Match match) {
        this.match=match;
    }
    ...
    public void initFacebook(){
        ...
        btnLoginFacebook.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                loading = ProgressDialog.show(getContext(), "Cargando","espere un momento...",false,false);
                ...
                for ( int i=0; i< valuesResult.length(); i++) {
                    ...
                    if (!obj.isNull("wallet")) {
                        ...
                        for (int j = 0; j < valuesWallet.length(); j++) {
                            JSONObject objJSONWallet = valuesWallet.getJSONObject(i);
                    ...
                    if (!obj.isNull("historical")) {
                        ...
                        for (int j = 0; j < valuesHistorical.length(); j++) {
                            JSONObject objJSONHistoricals = valuesHistorical.getJSONObject(i);
                    ...
                    if (! (obj.isNull("notifications"))) {
                        ...
                        */
                        ...
                        if(notificationMovementList.size()>0) {
                            ...
                            user.setCoins((user.getCoins() + addBalanceCoins) );
    ...
    public void showRegisterDialog() {
        ...
        */
        //LoginDialog eDialog = new LoginDialog();
        RegisterDialog eDialog = new RegisterDialog(match);
